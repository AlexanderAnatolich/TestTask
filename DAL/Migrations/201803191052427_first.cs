namespace DAL.Migrations
{
    ...
    public partial class first : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        PublishHouse_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.PublishHouses", t => t.PublishHouse_Id)
                .Index(t => t.PublishHouse_Id);
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Title = c.String(),
                        PrindDate = c.DateTime(nullable: false),
                        Price = c.Int(nullable: false),
                        DateInsert = c.DateTime(nullable: false),
                        PublishHouse_Id = c.Int(),
                    })
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.PublishHouses");
            DropTable("dbo.Books");
            DropTable("dbo.BookGenerRelations");
        }
    }
}
